    ...
    <main className="min-h-screen bg-[#f1f5f9] pb-12">
      <header className="border-b border-slate-100 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 md:px-8">
          <Link href="/menu" className="relative h-14 w-44 overflow-hidden md:h-16 md:w-52">
            <img src="/logo-nova.png" alt="NOVA Hub" width={650} height={366} className="absolute left-[-174px] top-[-109px] max-w-none" />
          </Link>
